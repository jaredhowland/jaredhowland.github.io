---
title: Licensing Business Resources
kind: presentation
permalink: /presentations/licensing-ala/
---
# Licensing Business Resources #

## <span class="caps">RUSA</span> Preconference at the American Library Association Annual Conference 2013 ##
Jared L. Howland
...
Another helpful tool is what I have called a summary form. As you read through a license agreement for the first time, it can be helpful to have a form similar to this one to fill out. This allows you to quickly identify areas that need to be negotiated. After the license is negotiated, it reduces the need to refer back to the actual agreement to answer basic questions about a specific license. It also makes it easier to put key terms of the license into an <span class="caps">ERM</span> system.
...
[PowerPoint]: {{ site.url }}/assets/images/presentations/files/licensing-ala/presentation_pptx.pptx
[PDF]: {{ site.url }}/assets/images/presentations/files/licensing-ala/presentation_pdf.pdf
[Keynote]: {{ site.url }}/assets/images/presentations/files/licensing-ala/presentation_keynote.zip
[Github]: https://github.com/jaredhowland/licensing

[1]: {{ site.url }}/assets/images/presentations/files/licensing-ala/presentation_001.jpg
[2]: {{ site.url }}/assets/images/presentations/files/licensing-ala/presentation_002.jpg
[3]: {{ site.url }}/assets/images/presentations/files/licensing-ala/presentation_003.jpg
[4]: {{ site.url }}/assets/images/presentations/files/licensing-ala/presentation_004.jpg
[5]: {{ site.url }}/assets/images/presentations/files/licensing-ala/presentation_005.jpg
[6]: {{ site.url }}/assets/images/presentations/files/licensing-ala/presentation_006.jpg
[7]: {{ site.url }}/assets/images/presentations/files/licensing-ala/presentation_007.jpg
